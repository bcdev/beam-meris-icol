                ...
                for (int x = targetRect.x; x < targetRect.x + targetRect.width; x++) {
                    ...
                    if (aep.getSampleInt(x, y) == 1 && rho_13 != -1 && rho_12 != -1) {
                        ...
                        if (!isLand.getSampleBoolean(x, y) && icolAerosolForWater) {
                            // RS, 04/12/09:
                            final double rho_4 = rhoRaec[TmConstants.LANDSAT_RADIANCE_4_BAND_INDEX].getSampleFloat(x,
                                                                                                                    y);
                            final double rho_3 = rhoRaec[TmConstants.LANDSAT_RADIANCE_3_BAND_INDEX].getSampleFloat(x,
                                                                                                                    y);
