 ...
 * @author Olaf Danne
 */
@OperatorMetadata(alias = "Landsat5.Tm.RadConversion",
        version = "1.0",
        internal = true,
        authors = "Olaf Danne",
...
public class TmRadConversionOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        ...
        radianceBandNames = LandsatConstants.LANDSAT5_RADIANCE_BAND_NAMES;
        reflectanceBandNames = LandsatConstants.LANDSAT5_REFLECTANCE_BAND_NAMES;
				...
				for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    for (int bandId = 0; bandId < radianceBandNames.length; bandId++) {
                        ...
                        if (bandId == LandsatConstants.LANDSAT5_RADIANCE_6_BAND_INDEX) {
                            ...
                            // ATBD ICOL_D4, eq. (23)
                            final double aRhoToa = LandsatUtils.convertRadToReflLandsat5(rad, cosSza, bandId, seasonalFactor);
