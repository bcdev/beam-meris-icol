 ...
 */
public class TmRayleighCorrection implements Constants {
     ...
     */
    public TmRayleighCorrection(L2AuxData auxData) {
        auxdata = auxData;
    ...
    public void ref_rayleigh(double delta_azimuth, double sun_zenith, double view_zenith,
        ...
        for (int bandId = 0; bandId < LandsatConstants.LANDSAT5_NUM_SPECTRAL_BANDS; bandId++) {
            if (bandId != LandsatConstants.LANDSAT5_RADIANCE_6_BAND_INDEX) {
...
\*-----------------------------------------------------------------------------*/
    ...
    public static class LocalHelperVariables {
        /**
         * Rayleigh reflectance Fourier components. Local helper variable used in {@link TmRayleighCorrection#ref_rayleigh}.
         */
        private final double[] rhoRayl = new double[RAYSCATT_NUM_SER];
        /**
         * Polynomial coeff for computation, a(s) in DPM. Local helper variable used in {@link TmRayleighCorrection#ref_rayleigh}.
         */
         ...
         * helper variable used in {@link TmRayleighCorrection#ref_rayleigh}.
         */
