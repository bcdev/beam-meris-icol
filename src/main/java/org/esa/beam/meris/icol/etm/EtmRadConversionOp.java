 ...
 */
@OperatorMetadata(alias = "Landsat.EtmRadConversion",
                  version = "1.0",
                  internal = true,
                  authors = "Olaf Danne",
...
public class EtmRadConversionOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        ...
        radianceBands = new Band[TmConstants.LANDSAT7_NUM_SPECTRAL_BANDS];
        reflectanceBands = new Band[TmConstants.LANDSAT7_NUM_SPECTRAL_BANDS];
        for (int i = 0; i < TmConstants.LANDSAT7_NUM_SPECTRAL_BANDS; i++) {
            radianceBands[i] = geometryProduct.getBand(TmConstants.LANDSAT7_RADIANCE_BAND_NAMES[i]);

            reflectanceBands[i] = targetProduct.addBand(TmConstants.LANDSAT7_REFLECTANCE_BAND_NAMES[i],
