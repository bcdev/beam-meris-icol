/*
 * $Id: MerisLandDistanceOp.java,v 1.6 2007/05/10 13:04:27 marcoz Exp $
 *
...
/**
 * Operator for land distance computation for AE correction.
 * CURRENTLY NOT USED ANY MORE! Replaced by MerisCoastDistanceOp.
 *
...
public class MerisLandDistanceOp extends MerisBasisOp {

    public static final String LAND_DISTANCE = "coast_distance";
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(MerisLandDistanceOp.class);
        }
    }
}
