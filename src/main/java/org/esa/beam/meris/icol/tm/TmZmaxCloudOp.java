 ...
 */
public class TmZmaxCloudOp extends TmBasisOp {
    ...
    public void initialize() throws OperatorException {
        ...
        BandMathsOp bandArithmeticOp =
            BandMathsOp.createBooleanExpressionBand(TmAeMaskOp.AE_MASK_RAYLEIGH + ".aep", aeMaskProduct);
    ...
    public void computeTile(Band band, Tile zmax, ProgressMonitor pm) throws OperatorException {
        ...
        try {
            ...
            Tile cloudTopPressure = getSourceTile(ctpProduct.getBand(TmConstants.LANDSAT5_CTP_BAND_NAME), targetRectangle, pm);
...
//                    }
                    ...
                    if (sourceRectangle.contains(p0Pix)) {
                        ...
                        if (l == TmCloudDistanceOp.NO_DATA_VALUE) {
                            zmax.setSample(x, y, -1);
                        } else {
