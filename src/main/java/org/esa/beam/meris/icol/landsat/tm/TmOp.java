...
/**
 * Class providing the correction of the adjacency effect for LANDSAT 5 TM data.
 *
 * @author Olaf Danne
...
@OperatorMetadata(alias = "icol.ThematicMapper",
                  ...
                  description = "Performs a correction of the adjacency effect for LANDSAT5 TM data.")
...
//        }
    ...
    private Product createRadianceCorrectionProduct(Product conversionProduct, Product gasProduct, Product aemaskRayleighProduct, Product aemaskAerosolProduct, Product aeRayProduct, Product aeAerProduct) {
        ...
        return GPF.createProduct(OperatorSpi.getOperatorAlias(TmRadianceCorrectionOp.class), radianceCorrectionParams, radianceCorrectionInput);
    }
    ...
    private Product createAeAerosolProduct(Product conversionProduct, Product cloudProduct, Product ctpProduct, Product landProduct, Product aemaskAerosolProduct, Product zmaxProduct, Product zmaxCloudProduct, Product aeRayProduct) {
        ...
        aeAerosolParams.put("instrument", Instrument.TM5);
        aeAerosolParams.put("numSpectralBands", LandsatConstants.LANDSAT5_NUM_SPECTRAL_BANDS);
    ...
    private Product createRayleighProduct(Product downscaledSourceProduct, Product conversionProduct, Product cloudProduct, Product ctpProduct, Product landProduct, Product fresnelProduct) {
        ...
        return GPF.createProduct(OperatorSpi.getOperatorAlias(TmRayleighCorrectionOp.class), rayleighParameters, rayleighInput);
    }
    ...
    private Product createLandProduct(Product conversionProduct) {
        ...
        landParameters.put("reflectanceBandNames", LandsatConstants.LANDSAT5_REFLECTANCE_BAND_NAMES);
    ...
    private Product createCtpProduct(Product conversionProduct, Product cloudProduct) {
        ...
        ctpParameters.put("thermalBandName", LandsatConstants.LANDSAT5_REFLECTANCE_6_BAND_NAME);
    ...
    private Product createCloudProduct(Product conversionProduct) {
        ...
        cloudParameters.put("reflectanceBandNames", LandsatConstants.LANDSAT5_REFLECTANCE_BAND_NAMES);
    ...
    private Product createConversionProduct(Product downscaledSourceProduct) {
        ...
        return GPF.createProduct(OperatorSpi.getOperatorAlias(TmRadConversionOp.class), conversionParameters, radianceConversionInput);
    }
    ...
    private Product createDownscaledProduct() {
        ...
        downscaledParameters.put("radianceBandNames", LandsatConstants.LANDSAT5_RADIANCE_BAND_NAMES);
    ...
    private Product createUpscaledToOriginalProduct(Product downscaledProduct, Product correctionProduct) {
        ...
        aeUpscaleParams.put("instrument", Instrument.TM5);
